...
int main() {
    ...
    char message[200];
    sprintf(message, "When the lights shut off. And it's my turn to settle down.My main concern. Promise that you will sing about me. Promise that you will sing about me");
    int i = 0;
    int c = 0;
    while (message[i]) {
